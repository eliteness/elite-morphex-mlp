...
async function gubs() {
	...
	$("mint-bal").innerHTML		=	(Number(_ubs[0])/1e18).toLocaleString(undefined,{maximumFractionDigits:18});
	$("redeem-bal").innerHTML	=	(Number(_ubs[1])/1e18).toLocaleString(undefined,{maximumFractionDigits:18});
	$("stake-bal").innerHTML	=	(Number(_ubs[1])/1e18).toLocaleString(undefined,{maximumFractionDigits:18});
	$("unstake-bal").innerHTML	=	(Number(_ubs[2])/1e18).toLocaleString(undefined,{maximumFractionDigits:18});
